...
import headPuzzle from "../assets/headPuzzle.svg";
import graduate from "../assets/graduate.svg";
import practicalLife from "../assets/practicalLife.svg";
import sensorial from "../assets/sensorial.svg";
        ...
        >
          <Grid container direction={matchesSM ? "column" : "row"}>
            <Grid item container sm justifyContent="center" alignItems="center">
              <img src={book} alt="ancient scroll" className={classes.book} />
            </Grid>
            <Grid
              item
              container
